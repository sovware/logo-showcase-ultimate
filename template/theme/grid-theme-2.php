<div class="wpwax-lsu-item wpwax-lsu-item__bordered">
    ...
    <div class="wpwax-lsu-item-inner" data-bs-placement="top" title="Conpany Name Sovware">
        ...
        <a href="<?php echo ! empty( $img_link ) ? $img_link : ''; ?>" target="<?php echo ! empty( $target ) ? $target : ''; ?>" data-bs-toggle="<?php echo ( 'yes' == $tooltip_show ) ? 'tooltip' : ''; ?>" data-bs-placement="top" title="<?php echo ! empty( $tooltip ) ? $tooltip : ''; ?>">

        ...
        if( ! empty( $old_posts ) ) {
            foreach( $old_posts as $old_post ) {
                ...
                if( 'c_theme1' == $get_meta['c_theme'] || 'c_theme2' == $get_meta['c_theme'] || 'c_theme7' == $get_meta['c_theme'] || 'c_theme8' == $get_meta['c_theme'] || 'c_theme9' == $get_meta['c_theme'] || 'c_theme10' == $get_meta['c_theme'] || 'c_theme11' == $get_meta['c_theme'] || 'c_theme12' == $get_meta['c_theme'] || 'c_theme13' == $get_meta['c_theme'] || 'c_theme14' == $get_meta['c_theme'] ) {
                    ...
                    $c_theme                            =  trim( $get_meta['c_theme'], '_theme' );
                    $new_meta['navigation']             =  $get_meta[$c_theme . '_nav'];
                    $new_meta['navarro_color']          =  $get_meta[$c_theme . '_navarro_color'];
                    $new_meta['nav_background']         =  $get_meta[$c_theme . '_nav_background'];
                    $new_meta['nav_border']             =  $get_meta[$c_theme . '_nav_border'];
                    $new_meta['nav_hov_arrow_color']    =  $get_meta[$c_theme . '_nav_hov_arrow_color'];
                    $new_meta['nav_hov_back_color']     =  $get_meta[$c_theme . '_nav_hov_back_color'];
                    $new_meta['nav_hov_border_color']   =  $get_meta[$c_theme . '_nav_hov_border_color'];

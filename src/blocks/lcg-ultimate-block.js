                    ...
                    <InspectorControls>
						...
						<PanelBody title={ __( 'Query', 'post-grid-carousel-ultimate' ) } initialOpen={ false }>
							...
							<SelectControl
								...
								options={ [
									...
									{ label: __( 'Random', 'post-grid-carousel-ultimate' ), value: 'rand' },
									{ label: __( 'A to Z (title)', 'post-grid-carousel-ultimate' ), value: 'title_asc' },
									{ label: __( 'Z to A (title)', 'post-grid-carousel-ultimate' ), value: 'title_desc' },
								] }
						...
						<SelectControl
								...
								options={ [
									...
									{ label: __( 'Theme 4', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-4' },
									{ label: __( 'Theme 5', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-5' },
									{ label: __( 'Theme 6', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-6' },
									{ label: __( 'Theme 7', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-7' },
									{ label: __( 'Theme 8', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-8' },
									{ label: __( 'Theme 9', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-9' },
									{ label: __( 'Theme 10', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-10' },
									{ label: __( 'Theme 11', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-11' },
									{ label: __( 'Theme 12', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-12' },
									{ label: __( 'Theme 13', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-13' },
									{ label: __( 'Theme 14', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-14' },
									{ label: __( 'Theme 15', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-15' },
									{ label: __( 'Theme 16', 'post-grid-carousel-ultimate' ), value: 'carousel-theme-16' },
								] }
							...
							<SelectControl
								...
								options={ [
									...
									{ label: __( 'Middle', 'post-grid-carousel-ultimate' ), value: 'around' },
						...
						{ layout == 'grid' ? <PanelBody title={ __( 'Grid', 'post-grid-carousel-ultimate' ) } initialOpen={ false }>
							...
							<SelectControl
								...
								options={ [
									...
									{ label: __( 'Theme 4', 'post-grid-carousel-ultimate' ), value: 'grid-theme-4' },
									{ label: __( 'Theme 5', 'post-grid-carousel-ultimate' ), value: 'grid-theme-5' },
									{ label: __( 'Theme 6', 'post-grid-carousel-ultimate' ), value: 'grid-theme-6' },
									{ label: __( 'Theme 7', 'post-grid-carousel-ultimate' ), value: 'grid-theme-7' },
									{ label: __( 'Theme 8', 'post-grid-carousel-ultimate' ), value: 'grid-theme-8' },
								] }
							...
							{ grid_pagination ? <SelectControl
								label={ __( 'Pagination Type', 'post-grid-carousel-ultimate' ) }
								labelPosition='side'
								value={ pagination_type }
								options={ [
									{ label: __( 'Number Pagination', 'post-grid-carousel-ultimate' ), value: 'number_pagi' },
									{ label: __( 'Ajax Pagination', 'post-grid-carousel-ultimate' ), value: 'ajax_pagi' },
								] }

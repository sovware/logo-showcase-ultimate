...
<div class="wpwax-logo-showcase-wrap wpwax-logo-showcase-grid wpwax-grid-theme-3 wpwax-logo-col-3">
    <h4 class="wpwax-logo-showcase-title">Grid Theme <span class="wpwax-logo-showcase-serial">#3</span> </h4>
    <div class="wpwax-logo-showcase-content">
        ...
        <div class="wpwax-logo-showcase-item">
            ...
            <div class="wpwax-logo-showcase-item-inner" data-wpwaxTooltip="Company Name Sovware good company great company">
                <a href=""> 

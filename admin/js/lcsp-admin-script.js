jQuery(document).ready(function($) {
    ...
    $('.lcsp-checkbox-wrapper, #lcsp_logos_byid, #lcsp_logos_from_year, #lcsp_logos_from_month, #lcsp_logos_from_month_year,.title-desc,.title-asc').hide();
    ...
    $('input[type="radio"]').click(function() {
        ...
        if($(this).attr('id') == 'title_desc') {
            $('.title-desc').show();
        }
        else {
            $('.title-desc').hide();
        }
        if($(this).attr('id') == 'title_asc') {
            $('.title-asc').show();
        }
        else {
            $('.title-asc').hide();
